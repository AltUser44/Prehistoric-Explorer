...
import { dinosaurData, type DinosaurData } from "@/lib/realistic-dinosaur-data"

interface RealisticDinosaurModelsProps {
  onDinosaurClick: (dinosaur: DinosaurData) => void
}

export default function RealisticDinosaurModels({ onDinosaurClick }: RealisticDinosaurModelsProps) {
  return (
    <>
      {dinosaurData.map((dino) => (
        <RealisticDinosaurModel
          key={dino.id}
          dinosaur={dino}
...
interface RealisticDinosaurModelProps {
...
function RealisticDinosaurModel({
  dinosaur,
  position,
  scale,
  rotation = [0, 0, 0],
  onClick,
}: RealisticDinosaurModelProps) {
  ...
  // Create high-quality dinosaur models using primitive shapes
  const renderDinosaurModel = () => {
    switch (dinosaur.id) {
      case "trex":
        return <HighQualityTRexModel />
      case "triceratops":
        return <HighQualityTriceratopsModel />
      case "velociraptor":
        return <HighQualityVelociraptorModel />
      case "brachiosaurus":
        return <HighQualityBrachiosaurusModel />
      case "stegosaurus":
        return <HighQualityStegosaurusModel />
      default:
        return <DefaultDinosaurModel />
    }
  }
...
// High-quality dinosaur models using primitive shapes
function HighQualityTRexModel() {
  return (
    <group>
      {/* Body */}
      <mesh position={[0, 2, 0]} castShadow>
        <capsuleGeometry args={[1, 2.5, 16, 32]} />
      ...
      <mesh position={[0, 2, -1.5]} rotation={[-0.1, 0, 0]} castShadow>
        <capsuleGeometry args={[0.6, 3, 16, 32]} />
        <meshStandardMaterial color="#8B4513" roughness={0.8} />
      </mesh>
      <mesh position={[0, 1.9, -3]} rotation={[-0.15, 0, 0]} castShadow>
        <capsuleGeometry args={[0.3, 2, 16, 32]} />
        <meshStandardMaterial color="#8B4513" roughness={0.8} />
      </mesh>
...
function HighQualityTriceratopsModel() {
  return (
    <group>
      {/* Body */}
      ...
      <mesh position={[0, 1.7, 1.2]} rotation={[Math.PI / 8, 0, 0]} castShadow>
        <capsuleGeometry args={[0.9, 0.8, 16, 32]} />
        <meshStandardMaterial color="#8B6914" roughness={0.8} />
      </mesh>
      ...
      <mesh position={[0, 1.9, 2.8]} castShadow>
        <coneGeometry args={[0.5, 0.8, 16]} rotation={[0, Math.PI / 4, 0]} />
        <meshStandardMaterial color="#8B6914" roughness={0.8} />
      </mesh>
...
function HighQualityVelociraptorModel() {
  return (
    <group>
      {/* Body */}
...
function HighQualityBrachiosaurusModel() {
  return (
    <group>
      {/* Body */}
      ...
      <mesh position={[0, 5, 1]} rotation={[Math.PI / 3.5, 0, 0]} castShadow>
        <capsuleGeometry args={[0.7, 6, 16, 32]} />
        <meshStandardMaterial color="#5F9EA0" roughness={0.8} />
      </mesh>
      ...
      <mesh position={[1.2, 2, 1.2]} castShadow>
        <capsuleGeometry args={[0.7, 3.5, 16, 32]} />
        <meshStandardMaterial color="#5F9EA0" roughness={0.8} />
      </mesh>
      <mesh position={[-1.2, 2, 1.2]} castShadow>
        <capsuleGeometry args={[0.7, 3.5, 16, 32]} />
...
function HighQualityStegosaurusModel() {
  return (
    <group>
      {/* Body */}
      <mesh position={[0, 1.5, 0]} castShadow>
        <capsuleGeometry args={[1.2, 2.8, 16, 32]} />
      ...
      {/* Legs */}
      <mesh position={[0.8, 0.9, 0.8]} castShadow>
        <capsuleGeometry args={[0.3, 1.6, 16, 32]} />
        <meshStandardMaterial color="#8B8878" roughness={0.8} />
      </mesh>
      <mesh position={[-0.8, 0.9, 0.8]} castShadow>
        <capsuleGeometry args={[0.3, 1.6, 16, 32]} />
        ...
        return (
          <group key={`plate-${i}`}>
            <mesh position={[0, 2.2 + height / 2, -1.2 + i * 0.4]} rotation={[0, 0, Math.PI / 2]} castShadow>
              <coneGeometry args={[height, 1.2, 16]} />
