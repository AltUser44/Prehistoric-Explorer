export interface DinosaurData {
  ...
  weight: string
  funFact: string
  modelPath: string // We'll keep this for future reference but won't use it
...
export const dinosaurData: DinosaurData[] = [
  {
    ...
    modelPath: "/models/trex.glb", // Kept for reference but not used
    position: [0, 0, 0],
  ...
  },
  {
    ...
    modelPath: "/models/triceratops.glb", // Kept for reference but not used
    position: [8, 0, 5],
  ...
  },
  {
    ...
    modelPath: "/models/velociraptor.glb", // Kept for reference but not used
    position: [-5, 0, -7],
  ...
  },
  {
    ...
    modelPath: "/models/brachiosaurus.glb", // Kept for reference but not used
    position: [-15, 0, -15],
    scale: [1.5, 1.5, 1.5],
    colliderSize: [3, 6, 5],
    labelHeight: 12,
  ...
  },
  {
    ...
    modelPath: "/models/stegosaurus.glb", // Kept for reference but not used
    position: [12, 0, -10],
